          ...
          <div className="grid h-full grid-cols-4 gap-3">
            {kelurahanData.map((kelurahan) => (
              <div
                ...
                <div className="bg-opacity-90 rounded bg-white p-2">
                ...
                {/* Hover tooltip */}
                {hoveredKelurahan === kelurahan.id && (
                  <div className="absolute -top-2 left-1/2 z-20 -translate-x-1/2 -translate-y-full transform rounded bg-black px-2 py-1 text-xs whitespace-nowrap text-white">
