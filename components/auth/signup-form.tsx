      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={`h-12 pl-12 pr-12 text-base ${errors.password ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={`h-12 pl-12 pr-12 text-base ${errors.confirmPassword ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
