...
export default function DeteksiAnomalyPage() {
  ...
  const selectedAnomalyData = selectedAnomaly
    ? mockAnomalyData.find((a) => a.id === selectedAnomaly)
    : null;
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">
                  Deteksi Anomali Penerima Bansos
                </h1>
                <p className="text-gray-600">
                  Identifikasi dan analisis pola tidak normal dalam penyaluran bantuan sosial
                </p>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            <Card>
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div>
                    <label className="mb-2 block text-sm font-medium">Jenis Anomali</label>
                  ...
                  <div>
                    <label className="mb-2 block text-sm font-medium">Tingkat Risiko</label>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Daftar Anomali ({filteredData.length} ditemukan)</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            {selectedAnomalyData ? (
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {selectedAnomalyData.details.registrationCount}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">Varians Jumlah</span>
                      <span className="font-medium">
                        {selectedAnomalyData.details.amountVariance}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">Rata-rata Regional</span>
                      <span className="font-medium">
                        Rp {selectedAnomalyData.details.avgRegionalAmount.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">Aktivitas Terakhir</span>
                      <span className="font-medium">
                        {new Date(selectedAnomalyData.details.lastActivity).toLocaleDateString(
                          'id-ID',
                        )}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <Badge variant="outline">
                        {selectedAnomalyData.details.verificationStatus}
                      </Badge>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  <AlertTriangle className="mx-auto mb-4 h-12 w-12 text-gray-400" />
                  <h3 className="mb-2 text-lg font-medium text-gray-900">Pilih Anomali</h3>
